...
sys.path.append(os.path.abspath('../omsi_server'))
sys.path.append(os.path.abspath('../'))
sys.path.append(os.path.abspath('../omsi_server/omsi_server'))


#Define the DJANGO settings to avoid having to set the DJANGO_SETTINGS_MODULE 
#environment variable
try :
   from omsi_server import settings
except :
   import settings
