...
import sys
import os
sys.path.append("/data/openmsi/bastet")
...
ALLOWED_DATAPATHS = ['/data/openmsi/omsi_data'] #'/project/projectdirs/openmsi/omsi_data']
...
SYSTEM_USER_RAWDATAPATHS = ['/project/projectdirs/openmsi/original_data']
